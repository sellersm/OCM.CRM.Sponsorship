...
Public NotInheritable Class D3CampaignBusinessProcess
	...
	Private Const outputTablePrefix As String = "USR_USP_D3_CAMPAIGN_BUSINESSPROCESS"
	...
	Public Overrides Function StartBusinessProcess() As Blackbaud.AppFx.Server.AppCatalog.AppBusinessProcessResult
		...
		Me.UpdateProcessStatus("Processing D3 Campaigns...")
			...
			Using Command As SqlCommand = Connection.CreateCommand()
				With Command
					Try
						...
						.CommandText = "dbo.USR_USP_D3_CAMPAIGN_BUSINESSPROCESS"
