...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'OCMCustomAddProjectSponsorshipFormINSTALLMENTS' data form
''' </summary>
Partial Public Class [OCMCustomAddProjectSponsorshipFormINSTALLMENTSUIModel]
