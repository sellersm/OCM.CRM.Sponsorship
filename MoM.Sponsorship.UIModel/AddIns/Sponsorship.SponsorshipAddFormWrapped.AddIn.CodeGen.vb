...
Partial Public NotInheritable Class SponsorshipAddIn
    Inherits Blackbaud.AppFx.UIModeling.Core.RootModelAddIn(Of Global.MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel)

    Friend WithEvents MODEL As Global.MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel
    ...
    Friend WithEvents [PFM] As Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
    ...
    Friend WithEvents [CHILDREN] As Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedCHILDRENUIModel)
    ...
    Friend WithEvents [GENDERCODE] As Global.Blackbaud.AppFx.UIModeling.Core.ValueListField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel.GENDERCODES?)
    Friend WithEvents [ISHIVPOSITIVECODE] As Global.Blackbaud.AppFx.UIModeling.Core.ValueListField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel.ISHIVPOSITIVECODES?)
    Friend WithEvents [HASCONDITIONCODE] As Global.Blackbaud.AppFx.UIModeling.Core.ValueListField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel.HASCONDITIONCODES?)
    Friend WithEvents [ISORPHANEDCODE] As Global.Blackbaud.AppFx.UIModeling.Core.ValueListField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel.ISORPHANEDCODES?)
    ...
    Friend WithEvents [PAYMENTMETHODCODE] As Global.Blackbaud.AppFx.UIModeling.Core.ValueListField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel.PAYMENTMETHODCODES)
    ...
    Friend WithEvents [FREQUENCYCODE] As Global.Blackbaud.AppFx.UIModeling.Core.ValueListField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel.FREQUENCYCODES)
    ...
    Friend WithEvents [CREDITCARDSCHEDULECODEID] As Global.Blackbaud.AppFx.UIModeling.Core.CodeTableField
    Friend WithEvents [DIRECTDEBITSCHEDULECODEID] As Global.Blackbaud.AppFx.UIModeling.Core.CodeTableField
    ...
    Friend WithEvents [SELECTOPPORTUNITYID] As Global.Blackbaud.AppFx.UIModeling.Core.ValueListField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedUIModel.SELECTOPPORTUNITYIDS?)
    ...
    Friend WithEvents [INSTALLMENTS] As Global.Blackbaud.AppFx.UIModeling.Core.CollectionField(Of MoM.Sponsorship.UIModel.SponsorshipAddFormWrappedINSTALLMENTSUIModel)
    ...
    Public Overrides Sub Init()
        ...
        Me.[CREDITCARDSCHEDULECODEID] = Me.HostModel.[CREDITCARDSCHEDULECODEID]
        Me.[DIRECTDEBITSCHEDULECODEID] = Me.HostModel.[DIRECTDEBITSCHEDULECODEID]
