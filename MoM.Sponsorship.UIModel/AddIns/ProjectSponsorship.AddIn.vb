...
Partial Public NotInheritable Class ProjectSponsorshipAddIn
    ...
    Private Sub OnInit()
		...
		myAddSponsorshipHelper = New AddSponsorshipHelper(MODEL, AddSponsorshipHelper.AddSponsorshipFormMode.ProjectSponsorship)
