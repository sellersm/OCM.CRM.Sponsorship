...
Partial Public NotInheritable Class ProspectSponsorshipAddIn
	...
	Private Sub OnInit()
		...
		myAddSponsorshipHelper = New AddSponsorshipHelper(MODEL, AddSponsorshipHelper.AddSponsorshipFormMode.ProspectChildSponsorship)
