...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'ProspectSponsorshipAddDataFormINSTALLMENTS' data form
''' </summary>
Partial Public Class [ProspectSponsorshipAddDataFormINSTALLMENTSUIModel]
