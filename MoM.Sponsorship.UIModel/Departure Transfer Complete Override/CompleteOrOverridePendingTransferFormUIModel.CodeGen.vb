...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'Complete Or Override Pending Transfer Form' data form
''' </summary>
<Global.Blackbaud.AppFx.UIModeling.Core.DataFormUIModelMetadata(Global.Blackbaud.AppFx.UIModeling.Core.DataFormMode.Edit, "928a3378-201e-4631-8eba-953f886a86a6", "cf6ed8e2-d7b0-454d-b495-49d766252df6", "Sponsorship")> _
Partial Public Class [CompleteOrOverridePendingTransferFormUIModel]
...
#End Region
	...
	Private WithEvents _fromchildid As Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
	Private WithEvents _tochildid As Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
	Private WithEvents _donorcontactcodeid As Global.Blackbaud.AppFx.UIModeling.Core.CodeTableField
	Private WithEvents _isoverride As Global.Blackbaud.AppFx.UIModeling.Core.BooleanField
	Private WithEvents _overrideflag As Global.Blackbaud.AppFx.UIModeling.Core.BooleanField
	...
	Public Sub New()
		...
		_fromchildid = New Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
		_tochildid = New Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
		...
		_revenueconstituentid.Required = False
		...
		_sponsorshipconstituentid.Required = False
		...
		_sponsorshipreasonid.DBReadOnly = False
		_sponsorshipreasonid.SimpleDataListId = New Guid("c8d3128e-a2eb-4413-b0b4-1585ad5bf001")
		_sponsorshipreasonid.Parameters.Add(New Global.Blackbaud.AppFx.UIModeling.Core.SimpleDataListParameter("TYPE", "5"))
		...
		_sponsorshipprogramid.Required = False
		...
		_paymentmethodcode.Required = False
		...
		'_fromchildid
		'
		_fromchildid.Name = "FROMCHILDID"
		_fromchildid.Caption = "Departed Child"
		_fromchildid.DBReadOnly = True
		_fromchildid.SearchListId = New Guid("ab076868-114a-4696-afe9-8d590677708c")
		Me.Fields.Add(_fromchildid)
		'
		'_tochildid
		'
		_tochildid.Name = "TOCHILDID"
		_tochildid.Caption = "Transfer Child"
		_tochildid.DBReadOnly = True
		_tochildid.SearchListId = New Guid("ab076868-114a-4696-afe9-8d590677708c")
		Me.Fields.Add(_tochildid)
		'
		'_donorcontactcodeid
		'
 ...
 Public ReadOnly Property [SPONSORSHIPOPPORTUNITYIDCHILD]() As Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
	...
	<System.CodeDom.Compiler.GeneratedCodeAttribute("BBUIModelLibrary", "2.93.2034.0")> _
	Public ReadOnly Property [FROMCHILDID]() As Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
		Get
			Return _fromchildid
		End Get
	End Property
	...
	<System.CodeDom.Compiler.GeneratedCodeAttribute("BBUIModelLibrary", "2.93.2034.0")> _
	Public ReadOnly Property [TOCHILDID]() As Global.Blackbaud.AppFx.UIModeling.Core.SearchListField(Of Guid)
		Get
			Return _tochildid
		End Get
	End Property
	...
	''' Override transfer
	''' </summary>
	<System.ComponentModel.Description("Override transfer")> _
	<System.CodeDom.Compiler.GeneratedCodeAttribute("BBUIModelLibrary", "2.93.2034.0")> _
	Public ReadOnly Property [ISOVERRIDE]() As Global.Blackbaud.AppFx.UIModeling.Core.BooleanField
		Get
			Return _isoverride
		End Get
	End Property
