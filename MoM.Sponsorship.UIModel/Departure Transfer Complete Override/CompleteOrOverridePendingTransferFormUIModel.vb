...
Public Class CompleteOrOverridePendingTransferFormUIModel
...
#End Region
	...
	Private Sub CompleteOrOverridePendingTransferFormUIModel_Loaded(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs) Handles Me.Loaded
	...
	Private Sub SetFieldsForTransferandReassign(ByVal reasontype As String)
		...
		Me.SPONSORSHIPREASONID.Required = (_overrideflag.Value)
