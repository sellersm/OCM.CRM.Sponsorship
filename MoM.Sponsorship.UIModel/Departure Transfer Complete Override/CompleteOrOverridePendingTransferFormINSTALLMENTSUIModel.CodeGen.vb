...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'CompleteOrOverridePendingTransferFormINSTALLMENTS' data form
''' </summary>
Partial Public Class [CompleteOrOverridePendingTransferFormINSTALLMENTSUIModel]
